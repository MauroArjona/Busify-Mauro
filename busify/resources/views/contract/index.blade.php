        ...
        <section class="clean-block clean-form dark" style="height: 100%;">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Lista de Contratos</h2>
                    <p>Lista de todos los contratos cargados en el sistema.</p>

                    <div class="d-flex justify-content-between align-items-center">
                        <form action="{{ route('contract.index') }}" method="GET" class="col-sm-6"
